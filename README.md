# BlitzAIProjectTemplates
Project templates for blitzai projects

Projects can be categorized into two forms:

- Python packages
- Non package based projects

## Project Templates
### Python Package projects:
Here projects are designed with an end goal of using them in the form
of a [python package](https://python-course.eu/python-tutorial/packages.php). Generally, a python package would like something like this
...
```
### Non package based projects:
Here projects are designed with an end goal of using them in the form of python
projects. These projects would have following structure,

```
Non_package_based_projects
├── PackageName_1
│   ├── _init__1.py
│   ├── f11.py
│   └── f12.py
...
## IDEs:
* [Visual Studio Code]( https://code.visualstudio.com) will be the go to IDE for all the python project developments.
* Install following extensions from Visual Studio Code for project tools
    * [GitLens-Git SuperCharged](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens): for git operations
    * [Remote Development](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.vscode-remote-extensionpack): for remote development purpose
    * [Python](https://marketplace.visualstudio.com/items?itemName=ms-python.python): for python coding, debugging, linting etc
    * [Docker](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker): For Docker operations
    * [Scratchpads](https://marketplace.visualstudio.com/items?itemName=awesomektvn.scratchpad): For rough work 
* Synch all these extensions and other settings of your VS code by signing into VS code as show in this video:


[![Sync VSCode settings](https://img.youtube.com/vi/3dsq39DEgZ8/0.jpg)](https://www.youtube.com/watch?v=3dsq39DEgZ8)
...
## Testing:
For every project whenever you write a new function or a class we need to add test case
for that in the test dir. The test directory will be in the root dir and it mirrors your project
...
└── tests    
    ...
    └── test_f2.py
```
Pytests will be used to define test cases as defined in this [source](https://madewithml.com/courses/mlops/testing/)

## Issue Template
Please use following template to raise an issue
...
#### Assignee 
Mark the person who needs to fix this issue, so that they are informed



## References:
1. [Google Python Style guide](https://github.com/google/styleguide/edit/gh-pages/pyguide.md)
